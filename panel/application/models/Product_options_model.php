<?php
class Product_options_model extends CI_Model
{
	public $tableName = "products_option";
	public function __construct()
	{
		parent::__construct();
		$this->column_order = array('rank', 'id', 'id', 'title', 'category_id','isActive');
        // Set searchable column fields
        $this->column_search = array('rank', 'id', 'id', 'title', 'category_id','isActive');
        // Set default order
