            ...
            <div class="widget p-lg">
                <?php if (empty($items)) : ?>
                    <div class="alert alert-info text-center">
                        <p>Burada herhangi bir veri bulunmamaktadır. Eklemek için lütfen <a href="<?= base_url("cinema_category/new_form"); ?>">tıklayınız</a></p>
                    </div>
                <?php else : ?>
                            ...
                            <?php foreach ($items as $item) : ?>
                                <tr id="ord-<?= $item->id; ?>">
                                    ...
                                    <td class="text-center w100">
                                        <input data-url="<?= base_url("cinema_category/isActiveSetter/$item->id"); ?>" class="isActive" type="checkbox" data-switchery data-color="#10c469" <?= ($item->isActive) ? "checked" : ""; ?> />
                                    </td>
