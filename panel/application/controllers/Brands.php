...
class Brands extends MY_Controller
{
    ...
    public function datatable()
    {
        ...
        foreach ($items as $item) {
            ...
            $item->img_url = "<img src='" . get_picture($this->viewFolder, $item->img_url, "178x57") . "' width='60px' height='60px' >";
            $checkbox = '<div class="custom-control custom-switch"><input data-id="' . $item->id . '" data-url="' . base_url("brands/check") . '" data-status="' . ($item->isActive == 1 ? "checked" : null) . '" id="customSwitch' . $i . '" type="checkbox" ' . ($item->isActive == 1 ? "checked" : null) . ' class="my-check custom-control-input" >  <label class="custom-control-label" for="customSwitch' . $i . '"></label></div>';
...
public function rankSetter()
    ...
    public function check()
    {
        ...
        $product = $this->brand_model->get(["id" => $id])->isActive;
        if ($product == 1) {
            $status = 0;
        } else {
            $status = 1;
        }
        if ($this->brand_model->update(["id" => $id], ["isActive" => $status])) {
