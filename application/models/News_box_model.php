...
class News_box_model extends CI_Model
{
	...
	{
		parent::__construct();
		$this->column_order = array('rank', 'id', 'id', 'title', 'added_news_id', 'which_news_id','isActive');
        // Set searchable column fields
        $this->column_search = array('rank', 'id', 'id', 'title', 'added_news_id', 'which_news_id','isActive');
        // Set default order
